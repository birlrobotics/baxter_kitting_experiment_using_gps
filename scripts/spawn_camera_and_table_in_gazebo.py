...
def setup_camera():
    ...
    tf_pub_process = subprocess.Popen('rosrun tf static_transform_publisher %s %s %s %s %s %s /base /baxter_kitting_expertiment_camera_frame 1000'%(x, y, z, tf_yaw, tf_pitch, tf_roll,), shell=True)
